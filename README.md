NOTE: project put on halt because I didn't think about if cases evaluating truthyness, which a userdata will always pass without interpreter hooks. (so you can't get all paths of execution)
